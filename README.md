...
5. GetPublicGame. Получение детальных данных игры.
Обязательный заголовок: `Authorization: Bearer [PARTNER_TOKEN]`
Принимаемые параметры:
...
6. GetPublicGamesList. Получение списка игр. Каждый раз когда игрок заходит на страницу со списком игр, получать данные об играх нужно именно из этого метода. Желательно кешировать хотя бы на 5-10 секунд.
Обязательный заголовок: `Authorization: Bearer [PARTNER_TOKEN]`
